...
import com.bass.jwtauthentication.message.request.SignUpForm;
import com.bass.jwtauthentication.message.response.JwtResponse;
...
public class AuthRestAPIs {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginForm loginRequest) {
        ...
        String jwt = jwtProvider.generateJwtToken(authentication); //jwt is the generated token
